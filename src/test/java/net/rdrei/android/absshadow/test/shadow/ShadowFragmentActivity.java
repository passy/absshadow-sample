...
public class ShadowFragmentActivity extends ShadowActivity {
        ...
        return new FragmentManager() {
            ...
            public FragmentTransaction beginTransaction() {
                return new FragmentTransaction() {
                    ...
                    @Override
                    public FragmentTransaction replace(int i,
                            Fragment fragment, String s) {
                        return null;
                    }
                    ...
                    @Override
                    public FragmentTransaction setBreadCrumbTitle(
                    ...
                    @Override
                    public FragmentTransaction setBreadCrumbShortTitle(
                            CharSequence charSequence) {
                        return null;
                    }
                    ...
                    @Override
                    public FragmentTransaction setCustomAnimations(int i,
            ...
            public void dump(String s, FileDescriptor fileDescriptor,
                    PrintWriter printWriter, String[] strings) {
            }
        };
    }
    ...
    public ActionBar getSupportActionBar() {
        return new ActionBar() {
            ...
            @Override
            public void addOnMenuVisibilityListener(
                    OnMenuVisibilityListener arg0) {
            }
        };
    }
